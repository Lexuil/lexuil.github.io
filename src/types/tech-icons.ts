export const techIcons: Record<string, { icon: string; color: `#${string}` }> = {
  ...
  SCSS: { icon: 'simple-icons:sass', color: '#CC6699' },
  ...
  'D3.js': { icon: 'simple-icons:d3dotjs', color: '#F9A03C' },
  Storybook: { icon: 'simple-icons:storybook', color: '#FF4785' },
  'Radix UI': { icon: 'simple-icons:radixui', color: '#161618' },
